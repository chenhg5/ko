...
func main() {
	...
	var (
		...
		prefix     = "/svc/order/"  // known at compile time
		instance   = "localhost:4003"       // taken from runtime or platform, somehow
	...
	mux.Handle("/svc/order/v1/", order.MakeHandler(orderSvc, httpLogger))
